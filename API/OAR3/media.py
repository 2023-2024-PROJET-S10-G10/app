...
class MediaAPI:
    ...
    def ls(self, path, limit, offset):
        ...
        return self.client.get(
            "/media/ls/" + path + ApiClient.queries(limit=limit, offset=offset)
        )
    ...
    def getMedia(self, path, tail):
        ...
        """
        return self.client.get(
            "/media" + ApiClient.queries(path=path, tail=tail)
        )
    ...
    def postMedia(self, fileName, force=False):
        ...
        with open(fileName, mode="rb") as file:
            return self.client.post(
                "/media" + ApiClient.queries(force=force), body=file.read()
            )
    ...
    def chmod(self, path, mode):
        ...
        """
        return self.client.post(
            "/media/chmod" + ApiClient.queries(path=path, mode=mode)
        )
