...
class JobAPI:
    ...
    def job(self, jobId, details: bool = False):
        ...
        return self.client.get(
            "/jobs/" + str(jobId) + ApiClient.queries(details=details)
        )
    ...
    def nodes(self, jobId, limit=500, offset=0):
        ...
        return self.client.get(
            ...
            + str(jobId)
            + "/nodes"
            + ApiClient.queries(limit=limit, offset=offset)
        )
    ...
    def deleteJob(self, jobId, array: bool = False):
        ...
        return self.client.delete(
            "/jobs/"
            + str(jobId)
            + ApiClient.queries(array="true" if array else "false")
        )
    ...
    def signal(self, jobId, signal):
        ...
        return self.client.post(
            "/jobs/" + str(jobId) + "/signal/" + str(signal)
        )
